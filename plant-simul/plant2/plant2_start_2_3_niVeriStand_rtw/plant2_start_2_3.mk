...
MODULES         		= rt_logging.c ni_modelframework.cpp plant2_start_2_3_data.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp
MAKEFILE        		= plant2_start_2_3.mk
...
MODELLIB                  				= plant2_start_2_3lib.lib
MODELREF_LINK_LIBS        		= 
MODELREF_LINK_RSPFILE			= plant2_start_2_3_ref.rsp
MODELREF_INC_PATH				= 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\plant2_start_2_3_niVeriStand_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\My academic stuff\TU Delft 2018-2020\Thesis-related\My Files\code\asamant_thesis\plant-simul\final\plant2
