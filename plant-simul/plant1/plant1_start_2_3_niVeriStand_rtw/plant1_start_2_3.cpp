...
/* Continuous states */
X_plant1_start_2_3_T plant1_start_2_3_X;

/* External inputs (root inport signals with default storage) */
ExtU_plant1_start_2_3_T plant1_start_2_3_U;

/* External outputs (root outports fed by signals with default storage) */
ExtY_plant1_start_2_3_T plant1_start_2_3_Y;

/* Real-time model */
RT_MODEL_plant1_start_2_3_T plant1_start_2_3_M_;
RT_MODEL_plant1_start_2_3_T *const plant1_start_2_3_M = &plant1_start_2_3_M_;
...
void plant1_start_2_3_output(void)
{
  real_T rtb_Plant_idx_0;
  real_T rtb_Plant_idx_1;
  if (rtmIsMajorTimeStep(plant1_start_2_3_M)) {
    /* set solver stop time */
    if (!(plant1_start_2_3_M->Timing.clockTick0+1)) {
      rtsiSetSolverStopTime(&plant1_start_2_3_M->solverInfo,
                            ((plant1_start_2_3_M->Timing.clockTickH0 + 1) *
        plant1_start_2_3_M->Timing.stepSize0 * 4294967296.0));
    } else {
      rtsiSetSolverStopTime(&plant1_start_2_3_M->solverInfo,
                            ((plant1_start_2_3_M->Timing.clockTick0 + 1) *
        plant1_start_2_3_M->Timing.stepSize0 +
        plant1_start_2_3_M->Timing.clockTickH0 *
        plant1_start_2_3_M->Timing.stepSize0 * 4294967296.0));
    }
  }                                    /* end MajorTimeStep */

  /* Update absolute time of base rate at minor time step */
  if (rtmIsMinorTimeStep(plant1_start_2_3_M)) {
    plant1_start_2_3_M->Timing.t[0] = rtsiGetT(&plant1_start_2_3_M->solverInfo);
  }

  /* StateSpace: '<Root>/Plant' */
  rtb_Plant_idx_0 = plant1_start_2_3_P.Plant_C[0] *
    plant1_start_2_3_X.Plant_CSTATE[0];
  rtb_Plant_idx_1 = plant1_start_2_3_P.Plant_C[1] *
    plant1_start_2_3_X.Plant_CSTATE[1];

  /* Outport: '<Root>/Out (y)' incorporates:
   *  Gain: '<Root>/Feeback input'
   */
  plant1_start_2_3_Y.Outy[0] = rtb_Plant_idx_0;
  plant1_start_2_3_Y.Outy[1] = rtb_Plant_idx_1;
  plant1_start_2_3_Y.Outy[2] = plant1_start_2_3_P.Feebackinput_Gain[0] *
    rtb_Plant_idx_0 + plant1_start_2_3_P.Feebackinput_Gain[1] * rtb_Plant_idx_1;
}

/* Model update function */
void plant1_start_2_3_update(void)
{
  if (rtmIsMajorTimeStep(plant1_start_2_3_M)) {
    rt_ertODEUpdateContinuousStates(&plant1_start_2_3_M->solverInfo);
  }
   ...
   */
  if (!(++plant1_start_2_3_M->Timing.clockTick0)) {
    ++plant1_start_2_3_M->Timing.clockTickH0;
  }

  plant1_start_2_3_M->Timing.t[0] = rtsiGetSolverStopTime
    (&plant1_start_2_3_M->solverInfo);

  {
     ...
     */
    if (!(++plant1_start_2_3_M->Timing.clockTick1)) {
      ++plant1_start_2_3_M->Timing.clockTickH1;
    }

    plant1_start_2_3_M->Timing.t[1] = plant1_start_2_3_M->Timing.clockTick1 *
      plant1_start_2_3_M->Timing.stepSize1 +
      plant1_start_2_3_M->Timing.clockTickH1 *
      plant1_start_2_3_M->Timing.stepSize1 * 4294967296.0;
  }
}

/* Derivatives for root system: '<Root>' */
void plant1_start_2_3_derivatives(void)
{
  XDot_plant1_start_2_3_T *_rtXdot;
  _rtXdot = ((XDot_plant1_start_2_3_T *) plant1_start_2_3_M->derivs);
  ...
  _rtXdot->Plant_CSTATE[0] += plant1_start_2_3_P.Plant_A[0] *
    plant1_start_2_3_X.Plant_CSTATE[1];
  _rtXdot->Plant_CSTATE[1] += plant1_start_2_3_P.Plant_A[1] *
    plant1_start_2_3_X.Plant_CSTATE[0];
  _rtXdot->Plant_CSTATE[1] += plant1_start_2_3_P.Plant_A[2] *
    plant1_start_2_3_X.Plant_CSTATE[1];
  _rtXdot->Plant_CSTATE[1] += plant1_start_2_3_P.Plant_B *
    plant1_start_2_3_U.Inputu;
}

/* Model initialize function */
void plant1_start_2_3_initialize(void)
{
  /* InitializeConditions for StateSpace: '<Root>/Plant' */
  plant1_start_2_3_X.Plant_CSTATE[0] =
    plant1_start_2_3_P.Plant_InitialCondition[0];
  plant1_start_2_3_X.Plant_CSTATE[1] =
    plant1_start_2_3_P.Plant_InitialCondition[1];
}

/* Model terminate function */
void plant1_start_2_3_terminate(void)
{
...
{
  plant1_start_2_3_initialize();
}

extern "C" void MdlTerminate(void)
{
  plant1_start_2_3_terminate();
}

/* Registration function */
extern "C" RT_MODEL_plant1_start_2_3_T *plant1_start_2_3(void)
{
  /* Registration code */
  ...
  (void) memset((void *)plant1_start_2_3_M, 0,
                sizeof(RT_MODEL_plant1_start_2_3_T));

  {
    /* Setup solver object */
    rtsiSetSimTimeStepPtr(&plant1_start_2_3_M->solverInfo,
                          &plant1_start_2_3_M->Timing.simTimeStep);
    rtsiSetTPtr(&plant1_start_2_3_M->solverInfo, &rtmGetTPtr(plant1_start_2_3_M));
    rtsiSetStepSizePtr(&plant1_start_2_3_M->solverInfo,
                       &plant1_start_2_3_M->Timing.stepSize0);
    rtsiSetdXPtr(&plant1_start_2_3_M->solverInfo, &plant1_start_2_3_M->derivs);
    rtsiSetContStatesPtr(&plant1_start_2_3_M->solverInfo, (real_T **)
                         &plant1_start_2_3_M->contStates);
    rtsiSetNumContStatesPtr(&plant1_start_2_3_M->solverInfo,
      &plant1_start_2_3_M->Sizes.numContStates);
    rtsiSetNumPeriodicContStatesPtr(&plant1_start_2_3_M->solverInfo,
      &plant1_start_2_3_M->Sizes.numPeriodicContStates);
    rtsiSetPeriodicContStateIndicesPtr(&plant1_start_2_3_M->solverInfo,
      &plant1_start_2_3_M->periodicContStateIndices);
    rtsiSetPeriodicContStateRangesPtr(&plant1_start_2_3_M->solverInfo,
      &plant1_start_2_3_M->periodicContStateRanges);
    rtsiSetErrorStatusPtr(&plant1_start_2_3_M->solverInfo, (&rtmGetErrorStatus
      (plant1_start_2_3_M)));
    rtsiSetRTModelPtr(&plant1_start_2_3_M->solverInfo, plant1_start_2_3_M);
  }

  rtsiSetSimTimeStep(&plant1_start_2_3_M->solverInfo, MAJOR_TIME_STEP);
  plant1_start_2_3_M->intgData.y = plant1_start_2_3_M->odeY;
  plant1_start_2_3_M->intgData.f[0] = plant1_start_2_3_M->odeF[0];
  plant1_start_2_3_M->intgData.f[1] = plant1_start_2_3_M->odeF[1];
  plant1_start_2_3_M->intgData.f[2] = plant1_start_2_3_M->odeF[2];
  plant1_start_2_3_M->contStates = ((real_T *) &plant1_start_2_3_X);
  rtsiSetSolverData(&plant1_start_2_3_M->solverInfo, (void *)
                    &plant1_start_2_3_M->intgData);
  rtsiSetSolverName(&plant1_start_2_3_M->solverInfo,"ode3");

  /* Initialize timing info */
  {
    int_T *mdlTsMap = plant1_start_2_3_M->Timing.sampleTimeTaskIDArray;
    mdlTsMap[0] = 0;
    mdlTsMap[1] = 1;
    plant1_start_2_3_M->Timing.sampleTimeTaskIDPtr = (&mdlTsMap[0]);
    plant1_start_2_3_M->Timing.sampleTimes =
      (&plant1_start_2_3_M->Timing.sampleTimesArray[0]);
    plant1_start_2_3_M->Timing.offsetTimes =
      (&plant1_start_2_3_M->Timing.offsetTimesArray[0]);

    /* task periods */
    plant1_start_2_3_M->Timing.sampleTimes[0] = (0.0);
    plant1_start_2_3_M->Timing.sampleTimes[1] = (0.01);

    /* task offsets */
    plant1_start_2_3_M->Timing.offsetTimes[0] = (0.0);
    plant1_start_2_3_M->Timing.offsetTimes[1] = (0.0);
  }

  rtmSetTPtr(plant1_start_2_3_M, &plant1_start_2_3_M->Timing.tArray[0]);

  {
    int_T *mdlSampleHits = plant1_start_2_3_M->Timing.sampleHitArray;
    mdlSampleHits[0] = 1;
    mdlSampleHits[1] = 1;
    plant1_start_2_3_M->Timing.sampleHits = (&mdlSampleHits[0]);
  }

  rtmSetTFinal(plant1_start_2_3_M, 10.0);
  plant1_start_2_3_M->Timing.stepSize0 = 0.01;
  plant1_start_2_3_M->Timing.stepSize1 = 0.01;

  /* Setup for data logging */
  {
    static RTWLogInfo rt_DataLoggingInfo;
    rt_DataLoggingInfo.loggingInterval = NULL;
    plant1_start_2_3_M->rtwLogInfo = &rt_DataLoggingInfo;
  }

  /* Setup for data logging */
  {
    rtliSetLogXSignalInfo(plant1_start_2_3_M->rtwLogInfo, (NULL));
    rtliSetLogXSignalPtrs(plant1_start_2_3_M->rtwLogInfo, (NULL));
    rtliSetLogT(plant1_start_2_3_M->rtwLogInfo, "tout");
    rtliSetLogX(plant1_start_2_3_M->rtwLogInfo, "");
    rtliSetLogXFinal(plant1_start_2_3_M->rtwLogInfo, "");
    rtliSetLogVarNameModifier(plant1_start_2_3_M->rtwLogInfo, "rt_");
    rtliSetLogFormat(plant1_start_2_3_M->rtwLogInfo, 4);
    rtliSetLogMaxRows(plant1_start_2_3_M->rtwLogInfo, 0);
    rtliSetLogDecimation(plant1_start_2_3_M->rtwLogInfo, 1);
    rtliSetLogY(plant1_start_2_3_M->rtwLogInfo, "");
    rtliSetLogYSignalInfo(plant1_start_2_3_M->rtwLogInfo, (NULL));
    rtliSetLogYSignalPtrs(plant1_start_2_3_M->rtwLogInfo, (NULL));
  }

  plant1_start_2_3_M->solverInfoPtr = (&plant1_start_2_3_M->solverInfo);
  plant1_start_2_3_M->Timing.stepSize = (0.01);
  rtsiSetFixedStepSize(&plant1_start_2_3_M->solverInfo, 0.01);
  rtsiSetSolverMode(&plant1_start_2_3_M->solverInfo, SOLVER_MODE_SINGLETASKING);

  /* parameters */
  plant1_start_2_3_M->defaultParam = ((real_T *)&plant1_start_2_3_P);

  /* states (continuous) */
  {
    real_T *x = (real_T *) &plant1_start_2_3_X;
    plant1_start_2_3_M->contStates = (x);
    (void) memset((void *)&plant1_start_2_3_X, 0,
                  sizeof(X_plant1_start_2_3_T));
  }

  /* external inputs */
  plant1_start_2_3_M->inputs = (((void*)&plant1_start_2_3_U));
  plant1_start_2_3_U.Inputu = 0.0;

  /* external outputs */
  plant1_start_2_3_M->outputs = (&plant1_start_2_3_Y);
  (void) memset(&plant1_start_2_3_Y.Outy[0], 0,
                3U*sizeof(real_T));

  /* Initialize Sizes */
  plant1_start_2_3_M->Sizes.numContStates = (2);/* Number of continuous states */
  plant1_start_2_3_M->Sizes.numPeriodicContStates = (0);/* Number of periodic continuous states */
  plant1_start_2_3_M->Sizes.numY = (3);/* Number of model outputs */
  plant1_start_2_3_M->Sizes.numU = (1);/* Number of model inputs */
  plant1_start_2_3_M->Sizes.sysDirFeedThru = (0);/* The model is not direct feedthrough */
  plant1_start_2_3_M->Sizes.numSampTimes = (2);/* Number of sample times */
  plant1_start_2_3_M->Sizes.numBlocks = (4);/* Number of blocks */
  plant1_start_2_3_M->Sizes.numBlockIO = (0);/* Number of block outputs */
  plant1_start_2_3_M->Sizes.numBlockPrms = (10);/* Sum of parameter "widths" */
  return plant1_start_2_3_M;
}
 ...
 */
#ifdef NI_ROOTMODEL_plant1_start_2_3
...
extern "C"
{
  extern plant1_start_2_3_rtModel *S;
...
{
  int index = 0, count = 0;
  ExtU_plant1_start_2_3_T *rtIN = (ExtU_plant1_start_2_3_T*) S->inputs;
...
{
  int index = 0, count = 0;
  ExtY_plant1_start_2_3_T* rtOUT = (ExtY_plant1_start_2_3_T*) S->outputs;
  if (TaskSampleHit[0]) {              // sample and hold
...
{
  { 0, "plant1_start_2_3/Plant/A", offsetof(P_plant1_start_2_3_T, Plant_A), 0, 3,
    2, 0, 0 },

  { 1, "plant1_start_2_3/Plant/B", offsetof(P_plant1_start_2_3_T, Plant_B), 0, 1,
    2, 2, 0 },

  { 2, "plant1_start_2_3/Plant/C", offsetof(P_plant1_start_2_3_T, Plant_C), 0, 2,
    2, 4, 0 },

  { 3, "plant1_start_2_3/Plant/InitialCondition", offsetof(P_plant1_start_2_3_T,
    Plant_InitialCondition), 0, 2, 2, 6, 0 },

  { 4, "plant1_start_2_3/Feeback input/Gain", offsetof(P_plant1_start_2_3_T,
...
{
  { 0, "plant1_start_2_3/Input (u)", 0, "", offsetof(ExtU_plant1_start_2_3_T,
...
static const char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "plant1_start_2_3";
static const char* NI_CompiledModelVersion = "1.21";
static const char* NI_CompiledModelDateTime = "Tue Jul  7 13:43:34 2020";
...
{
  memcpy(&rtParameter[0], &plant1_start_2_3_P, sizeof(P_plant1_start_2_3_T));
  return NI_OK;
}

/*  After the model has initialized and updated the parameters in
   rtParameter[0] (aka plant1_start_2_3_P) we make a copy to rtParameter[1] so
...
extern "C" int32_t NI_InitParamDoubleBuf()
{
  ...
  for (; idx <= NUMST - TID01EQ; idx++)
    ...
    memcpy(&rtParameter[idx], &rtParameter[0], sizeof(P_plant1_start_2_3_T));
  return NI_OK;
}
  ...
  * clockTicksNames, int32_t* clockTicks)
{
  ...
  if ((contStates != NULL) && (contStatesNames != NULL)) {
    idx = 0;
    contStates[idx] = NIRT_GetValueByDataType(&(plant1_start_2_3_X.Plant_CSTATE),
      0, 0, 0);
  ...
  int32_t* clockTicks)
{
  ...
  if (contStates != NULL) {
    idx = 0;
    NIRT_SetValueByDataType(&(plant1_start_2_3_X.Plant_CSTATE), 0,
      contStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&(plant1_start_2_3_X.Plant_CSTATE), 1,
      contStates[idx++], 0, 0);
  }
...
#endif                                 // of NI_ROOTMODEL_plant1_start_2_3
