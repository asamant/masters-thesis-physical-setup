# File    : NIVeriStand_vc.tmf (for Release 2010b and later)
#
# Abstract:
...
MODULES         		= rt_logging.c ni_modelframework.cpp plant1_start_4_1_data.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp
MAKEFILE        		= plant1_start_4_1.mk
MATLAB_ROOT     		= D:\MATLAB\R2018a
ALT_MATLAB_ROOT 		= D:\MATLAB\R2018a
MATLAB_BIN      		= D:\MATLAB\R2018a\bin
ALT_MATLAB_BIN  		= D:\MATLAB\R2018a\bin
MASTER_ANCHOR_DIR    	= 
START_DIR          		= D:\My academic stuff\TU Delft 2018-2020\Thesis-related\Resources
S_FUNCTIONS     		= 
S_FUNCTIONS_LIB 		= 
SOLVER          		= 
NUMST           		= 2
TID01EQ         		= 1
NCSTATES        		= 2
BUILDARGS       		=  EXT_MODE=0 EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 MAT_FILE=1 NIDEBUG=0 NIOPT="Default" OPTS="" COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING
MULTITASKING    		= 0
EXT_MODE        		= 0
...
NIVERISTAND_ROOT		= D:\VeriStand\2019
...
MODELLIB                  				= plant1_start_4_1lib.lib
MODELREF_LINK_LIBS        		= 
MODELREF_LINK_RSPFILE			= plant1_start_4_1_ref.rsp
MODELREF_INC_PATH				= 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\plant1_start_4_1_niVeriStand_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\My academic stuff\TU Delft 2018-2020\Thesis-related\My Files\code\asamant_thesis\plant-simul\final\plant1_altstart
